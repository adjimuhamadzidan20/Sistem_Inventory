...
@section('container')
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h3 class="fw-bold mb-3"><i class="fas fa-layer-group me-1"></i> Data Barang Keluar</h3>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('barangkeluar_create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    @foreach ($barangkeluar as $data)
                                        <tr>
                                            ...
                                            <td class="text-center text-nowrap">
                                                <a href="{{ route('barangkeluar_edit', ['id' => $data->id]) }}" class="btn btn-primary btn-sm" title="ubah data"><i class="fas fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fas fa-trash me-1"></i> Hapus data barang keluar</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Anda yakin ingin menghapus {{ $data->kd_barangkeluar }}?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-black btn-sm" data-bs-dismiss="modal">Batal</button>
                                                            <a href="{{ route('barangkeluar_hapus', ['id' => $data->id]) }}" class="btn btn-primary btn-sm">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
